...
//        WebDriverWait wait = new WebDriverWait(driver, 5);
    ...
    public void signIn() { this.signIn.click(); }

    public void inputEmail(String userEmail) { this.userEmail.sendKeys(userEmail); }

    public void inputPassWrd(String userPassword) { this.userPassword.sendKeys(userPassword); }

    public void logIn() { this.logIn.click(); }

    public void selectGroup() { this.customerGroup.click(); }

    public void selectDepartment() { this.department.click(); }

    public void selectDressCode() { this.dressCode.click(); }

    public void selectProduct() { this.product.click(); }

    public void addToCart() { this.addToCart.click(); }

    public void checkOut_1() { this.checkOut1.click(); }

    public void checkOut_2() { this.checkOut2.click(); }

    public void checkDeliveryBillAddress() { this.checkAddress.click(); }

    public void agreeOnTerms() { this.agreeOnTerms.click(); }

    public void checkOut_3() { this.checkOut3.click(); }

    public void selectPayCheck() { this.payCheck.click(); }

    public String getOrderAmount() { return (this.orderAmount.getText()); }

    public void userConfirmOrder() { this.confirmOrder.click(); }

    public String completeOrderMsg() { return (this.orderComplete.getText()); }

    public void backToOrder() { this.backToOrder.click(); }

    public String getTotalPrice() { return (this.orderPrice.getText()); }

    public void logOff() { this.logOff.click(); }
